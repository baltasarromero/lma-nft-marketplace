...
import '../interfaces/IERC721WithPermit.sol';
...
abstract contract ERC721WithPermit is IERC721WithPermit, ERC721 {
    ...
    function nonces(uint256 tokenId) public view returns (uint256) {
        require(_exists(tokenId), 'ERC721WithPermit: UNKNOWN_TOKEN!');
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, 'ERC721WithPermit: PERMIT_DEADLINE_EXPIRED!');
        ...
        require(
            ...
            'ERC721WithPermit: INVALID_PERMIT_SIGNATURE!'
        );
